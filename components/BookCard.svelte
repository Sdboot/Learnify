...
<div class="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition transform hover:-translate-y-1">
	...
	<div class="p-4">
		...
		<div class="flex gap-2 mb-3 flex-wrap">
			<span class="text-xs bg-primary/10 dark:bg-primary/20 text-primary dark:text-indigo-300 px-2 py-1 rounded">
				{book.category}
			</span>
			<span class="text-xs bg-secondary/10 dark:bg-secondary/20 text-secondary dark:text-purple-300 px-2 py-1 rounded">
				{book.level}
			</span>
		</div>
		...
		<a
			href="/book/{book.id}"
			class="block w-full text-center py-2 px-3 bg-primary dark:bg-indigo-600 text-white rounded font-semibold hover:bg-primary/90 dark:hover:bg-indigo-700 transition text-sm"
		>
			View Details
		</a>
	</div>
